...
namespace MonolithicBase.Tests;

public class ArchitectureTests
{

    private const string DomainNamespace = "MonolithicBase.Domain";
    private const string ApplicationNamespace = "MonolithicBase.Application";
    private const string InfrastructureNamespace = "MonolithicBase.Infrastructure";
    private const string PersistenceNamespace = "MonolithicBase.Persistence";
    private const string PresentationNamespace = "MonolithicBase.Presentation";
    private const string ApiNamespace = "MonolithicBase.API";
    ...
    {
        // Arrage
        var assembly = MonolithicBase.Domain.AssemblyReference.Assembly;
