...
using CommandV1 = MonolithicBase.Contract.Services.V1.Product;
using CommandV2 = MonolithicBase.Contract.Services.V2.Product;

namespace MonolithicBase.Presentation.APIs.Products;
